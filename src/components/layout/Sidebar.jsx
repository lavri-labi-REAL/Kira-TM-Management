...
import {
  LayoutDashboard, FileText, Clock, FolderOpen, RefreshCw, Globe, ChevronRight
} from 'lucide-react'
...
export function Sidebar() {
  return (
    <aside className="bg-gray-800 text-white w-64 min-h-screen flex flex-col flex-shrink-0">
      {/* Logo */}
